...
<body>
		<h1
			style="border: 4px black solid; background-color:blue; border-radius:10px; color: white; text-align: center; max-width: fit-content; margin-left: auto; margin-right: auto;">Legal
			DashBoard</h1>
